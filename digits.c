// Ask user what place he/she wants to change, AND ask what number he/she wants
// it to be Digits 0 - 9
#include <math.h>
#include <stdio.h>
...
int main() {
  // TODO: Main is too long, break this up to functions!
  int input;
  int number[9] = {0, 1, 2, 4, 5, 6, 7, 8};
  ...
  printf("%d%d%d, %d%d%d, %d%d%d", number[8], number[7], number[6], number[5],
